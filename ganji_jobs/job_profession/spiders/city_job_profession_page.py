...
class CityJobProfessionPageSpider(scrapy.Spider):
    name = "city_job_profession_page"
    allowed_domains = ["ganji.com"]
    base = "ganji.com"

    def __init__(self, city_en, *args, **kwargs):
        self.start_urls = ['http://%s.ganji.com/zhaopin/' % city_en]
        self.db = MySQLdb.connect(host="localhost", user="root", db="ganji", charset='utf8')
   ...
   #http://anshan.ganji.com/zhaopin/
    ...
    def parse_job_item(self, response):
        ...
        if not self.cursor.execute(self.sql_check_jp_item, id):
            ...
            try :
                                            #//*[@id="wrapper"]/div[6]/div[1]/div[5]/ul/li[1]/em/a
                ...
                job_profession = response.xpath('//*[@id="wrapper"]/div[6]/div[1]/div[5]/ul/li[1]/em/a/text()').extract()[0]
                job_salary = response.xpath('//*[@id="wrapper"]/div[6]/div[1]/div[5]/ul/li[2]/em/text()').extract()[0]
                job_education = response.xpath('//*[@id="wrapper"]/div[6]/div[1]/div[5]/ul/li[3]/em/text()').extract()[0]
                job_experience = response.xpath('//*[@id="wrapper"]/div[6]/div[1]/div[5]/ul/li[4]/em/text()').extract()[0]
                job_age = response.xpath('//*[@id="wrapper"]/div[6]/div[1]/div[5]/ul/li[5]/em/text()').extract()[0]
                job_vacancy = response.xpath('//*[@id="wrapper"]/div[6]/div[1]/div[5]/ul/li[6]/em/text()').extract()[0]
